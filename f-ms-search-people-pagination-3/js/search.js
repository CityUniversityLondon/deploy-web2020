...
const endKey = 'End',
      ...
      arrowDown = 'ArrowDown'; // Dynamic variable; 'Browse more' link path value changes depending on which tab is viewed
...
function Search__Results(props) {
  ...
  const panels = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("section", {
    ...
    // People tab goes to bespoke People landing page template
    finder.collection === 'web2020-profiles' ? browseMorePath = 'https://www.city.ac.uk/staging/development/mark/search-people-tab/landing-page-template/landing-page?query=' + props.query.query : browseMorePath = finder.search + '?query=' + props.query.query;

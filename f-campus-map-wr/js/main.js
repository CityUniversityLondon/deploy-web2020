...
function createMap() {
  console.log("create map run"); // == PROPERTIES ==
  ...
  function parseXml(xml) {
    ...
    function searchBoxInit() {
      ...
      let listWrapper = Object(_util__WEBPACK_IMPORTED_MODULE_1__["createHTMLElement"])('div', [{
        label: 'class',
        val: 'query__suggestions__wrapper'
      }]);
      let list = Object(_util__WEBPACK_IMPORTED_MODULE_1__["createHTMLElement"])('ul', [{
        label: 'id',

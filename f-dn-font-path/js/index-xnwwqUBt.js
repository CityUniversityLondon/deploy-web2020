...
function requireTabbable() {
  if (hasRequiredTabbable) return tabbable_1;
...
function requireFocusTrap() {
  if (hasRequiredFocusTrap) return focusTrap_1;
  hasRequiredFocusTrap = 1;
  var tabbable = requireTabbable();
...
var focusTrapExports = requireFocusTrap();
const createFocusTrap = /* @__PURE__ */ getDefaultExportFromCjs(focusTrapExports);
export {
  createFocusTrap as c
};
//# sourceMappingURL=index-xnwwqUBt.js.map

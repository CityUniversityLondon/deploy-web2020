...
/* harmony import */ var _components_query_events_query__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/query/events__query */ "./src/patterns/events/components/query/events__query.js");
/* harmony import */ var _components_filters_events_filters__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/filters/events__filters */ "./src/patterns/events/components/filters/events__filters.js");
/* harmony import */ var _components_filters_events_filtersmobile__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/filters/events__filtersmobile */ "./src/patterns/events/components/filters/events__filtersmobile.js");
...
function Events(props) {
  ...
  const [pastEventsQuery, setPastEventsQuery] = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(pastEventsInitialQuery);
  const [pastEventsFunnelbackResponse, setPastEventsFunnelbackResponse] = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(pastEventsInitialResponse); // Boolean to indicate when a query is in progress

  const [updating, setUpdating] = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(true); // Request token from the Funnelback request object, so we can cancel if
  ...
  const [update, setUpdate] = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(false); // Retrieve Funnelback results
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(() => {
    ...
    const [request, requestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_5__["find"])(query.collection, query.fixedFacets, query.fixedParameters, query.query, query.sortType, query.startRank, query.numRanks, query.facets, query.events);
    const [pastEventsRequest, pastEventsRequestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_5__["find"])(pastEventsQuery.collection, pastEventsQuery.fixedFacets, pastEventsQuery.fixedParameters, pastEventsQuery.query, pastEventsQuery.sortType, pastEventsQuery.startRank, pastEventsQuery.numRanks, pastEventsQuery.facets, pastEventsQuery.events); // save the requestToken
    ...
    request.then(data => {
      ...
      query.interacted && zenscroll__WEBPACK_IMPORTED_MODULE_10___default.a.center(props.element.querySelector('.finder__results h2'), scrollDuration);
    }).catch(() => {
  ...
  const queryElement = props.config.noQuery && props.config.noQuery === true ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_components_query_events_query__WEBPACK_IMPORTED_MODULE_6__["default"], {
    config: props.config,
    query: query,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("form", {
  ...
  }, queryElement, props.config.facetLabels.length > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_components_filters_events_filtersmobile__WEBPACK_IMPORTED_MODULE_8__["default"], {
    config: props.config,
    query: query,
    pastEventsQuery: pastEventsQuery,
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_components_filters_events_filters__WEBPACK_IMPORTED_MODULE_7__["default"], {
    config: props.config,
    query: query,
    pastEventsQuery: pastEventsQuery,
    response: funnelbackResponse,
    ...
    pastEventsUpdate: pastEventsUpdater,
    clear: clear
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_finder_components_results_finder_results__WEBPACK_IMPORTED_MODULE_9__["default"], {
    clear: clear,
    config: props.config,
    query: query,
    response: funnelbackResponse,

...
/* harmony import */ var _components_filters_filtersmobile__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/filters/filtersmobile */ "./src/patterns/destination-leavers-higher-ed/components/filters/filtersmobile.js");
/* harmony import */ var _components_results_results__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/results/results */ "./src/patterns/destination-leavers-higher-ed/components/results/results.js");
/* harmony import */ var zenscroll__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! zenscroll */ "./node_modules/zenscroll/zenscroll.js");
/* harmony import */ var zenscroll__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(zenscroll__WEBPACK_IMPORTED_MODULE_25__);
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../../util */ "./src/util.js");
/* harmony import */ var _finder_logic_replace_history__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../finder/logic/replace-history */ "./src/patterns/finder/logic/replace-history.js");
/* harmony import */ var _finder_logic_url_params__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../finder/logic/url-params */ "./src/patterns/finder/logic/url-params.js");
/* harmony import */ var _finder_logic_has_mounted__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../finder/logic/has-mounted */ "./src/patterns/finder/logic/has-mounted.js");
...
var oneSecond = 1000,
    scrollDuration = Object(_util__WEBPACK_IMPORTED_MODULE_26__["reduceMotion"])() ? 0 : oneSecond,
...
function DestinationLeaversHE(props) {
   ...
   */
  var hasMounted = Object(_finder_logic_has_mounted__WEBPACK_IMPORTED_MODULE_29__["default"])(); // check if we in Matrix
  ...
  var initialQuery = {
    ...
    facets: props.config.facetLabels.length > 0 && params ? Object(_finder_logic_url_params__WEBPACK_IMPORTED_MODULE_28__["getFacetParams"])(props.config.facetLabels, params, matrixState) : {},
    parameters: nonFBParams.length > 0 && params ? Object(_finder_logic_url_params__WEBPACK_IMPORTED_MODULE_28__["getNonFBParams"])(props.config.facetLabels, params, matrixState) : {},
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_19__["useEffect"])(function () {
    // preserve the state
    Object(_finder_logic_replace_history__WEBPACK_IMPORTED_MODULE_27__["default"])(query.query, query.startRank, query.facets, query.parameters, query.sortType, props.config.facetLabels, props.config.sort[0].type, hasMounted); // indicate a request is in progress

    setUpdating(true);
    query.interacted && zenscroll__WEBPACK_IMPORTED_MODULE_25___default.a.center(props.element.querySelector('.finder__results'), scrollDuration, -window.innerHeight / screenOffsetRatio);
    /**
    ...
    var _find = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_21__["find"])(query.collection, query.fixedFacets, query.fixedParameters, query.query, query.sortType, query.startRank, query.numRanks, query.facets, query.parameters, props.config.dxp ? props.config.dxp : false),
    ...
    request.then(function (data) {
      setResponse(Object(_finder_logic_FB_formatter__WEBPACK_IMPORTED_MODULE_22__["formatFBResponse"])(data));
      setUpdating(false);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_19___default.a.createElement("form", {
    ...
    href: "/prospective-students/career-development/careers-team"
  }, "careers department"), ' ', "at City for full details")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_19___default.a.createElement(_components_results_results__WEBPACK_IMPORTED_MODULE_24__["default"], {
    clear: clear,
    config: props.config,
    query: query,
    response: funnelbackResponse,

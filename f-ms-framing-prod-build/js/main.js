...
function toggleButton(button, selected) {
  button.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].selected, selected);

  if (selected) {
    button.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].current, true);
  } else {
    button.removeAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].current);
  }
}
/**
...
function keyEvents(e, tabs) {
  const currentTab = tabs.querySelector("[".concat(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].selected, "=\"true\"]")),
...
function launchTabs(tabs) {
  ...
  if (linkItems.length === 1) {
     ...
     */
    Object(_util__WEBPACK_IMPORTED_MODULE_0__["removeClass"])(tabs, className, false);
    return;
  }
  ...
  if (window.location.hash) {
    ...
    if (button) {
      ...
      if (isTabAccordion && Object(_util__WEBPACK_IMPORTED_MODULE_0__["screenWidth"])('tablet') < viewportWidth) {

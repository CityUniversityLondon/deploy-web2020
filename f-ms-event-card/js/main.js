...
function Finder(props) {
  ...
  }, [call, initialResponse, props.config.facetLabels, props.config.sort, props.element, query, update]); // update props so child components can update the query

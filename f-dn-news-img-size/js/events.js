...
/* harmony import */ var _events_select__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./events__select */ "./src/patterns/events/components/filters/events__select.js");
/* harmony import */ var _finder_components_filters_finder_checkbox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../finder/components/filters/finder__checkbox */ "./src/patterns/finder/components/filters/finder__checkbox.js");
/* harmony import */ var _finder_components_filters_finder_tag__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../finder/components/filters/finder__tag */ "./src/patterns/finder/components/filters/finder__tag.js");
/* harmony import */ var _finder_components_filters_finder_reset__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../finder/components/filters/finder__reset */ "./src/patterns/finder/components/filters/finder__reset.js");
/* harmony import */ var _finder_components_filters_finder_sort__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../finder/components/filters/finder__sort */ "./src/patterns/finder/components/filters/finder__sort.js");
/* harmony import */ var _events_checkbox_allevents__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./events__checkbox__allevents */ "./src/patterns/events/components/filters/events__checkbox__allevents.js");
...
function Finder__Filters(props) {
  ...
  const clearFiltersDesktop = Object.keys(props.query.facets).length > 0 || props.query.events !== '' ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "finder__filters__reset finder__filters__reset--desktop"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_finder_components_filters_finder_reset__WEBPACK_IMPORTED_MODULE_6__["default"], {
    clear: props.clear,
    resetSort: false
  })) : null,
        clearFiltersMobile = Object.keys(props.query.facets).length > 0 || props.query.sortType !== props.config.sort[0].type ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_finder_components_filters_finder_reset__WEBPACK_IMPORTED_MODULE_6__["default"], {
    clear: props.clear,
    resetSort: true
  }) : null;
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_finder_components_filters_finder_sort__WEBPACK_IMPORTED_MODULE_7__["default"], {
    config: props.config,
    query: props.query,
    update: props.update,
    pastEventsUpdate: props.pastEventsUpdate
  })) : null;
  const pastEventsCheckBox = pastFullyOrPartiallyMatching ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_events_checkbox_allevents__WEBPACK_IMPORTED_MODULE_8__["default"], {
    query: props.query,
    update: props.update,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    if (dependencyMet(facet, props.query.facets)) {
      switch (facet.type) {
        case 'select':
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_events_select__WEBPACK_IMPORTED_MODULE_3__["default"], {
            key: facet.meta,
            facet: facet,
            query: props.query,
        ...
        case 'checkbox':
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_finder_components_filters_finder_checkbox__WEBPACK_IMPORTED_MODULE_4__["default"], {
            key: facet.meta,
            facet: facet,
            query: props.query,
            pastEventsQuery: props.pastEventsQuery,
        ...
        case 'tag':
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_finder_components_filters_finder_tag__WEBPACK_IMPORTED_MODULE_5__["default"], {
            key: facet.meta,
            facet: facet,
            query: props.query,
            pastEventsQuery: props.pastEventsQuery,
  ...
  }), pastEventsCheckBox, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", {
...
/* harmony import */ var _components_filters_events_filters__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/filters/events__filters */ "./src/patterns/events/components/filters/events__filters.js");
/* harmony import */ var _components_filters_events_filtersmobile__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/filters/events__filtersmobile */ "./src/patterns/events/components/filters/events__filtersmobile.js");
/* harmony import */ var _finder_components_results_finder_results__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../finder/components/results/finder__results */ "./src/patterns/finder/components/results/finder__results.js");
...
const oneSecond = 1000,
      scrollDuration = Object(_util__WEBPACK_IMPORTED_MODULE_13__["reduceMotion"])() ? 0 : oneSecond,
...
function Events(props) {
  ...
  const [pastEventsQuery, setPastEventsQuery] = Object(react__WEBPACK_IMPORTED_MODULE_5__["useState"])(pastEventsInitialQuery);
  const [pastEventsFunnelbackResponse, setPastEventsFunnelbackResponse] = Object(react__WEBPACK_IMPORTED_MODULE_5__["useState"])(pastEventsInitialResponse); // Boolean to indicate when a query is in progress

  const [updating, setUpdating] = Object(react__WEBPACK_IMPORTED_MODULE_5__["useState"])(true); // Request token from the Funnelback request object, so we can cancel if
  ...
  const [update, setUpdate] = Object(react__WEBPACK_IMPORTED_MODULE_5__["useState"])(false); // Retrieve Funnelback results
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(() => {
    ...
    const [request, requestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_7__["find"])(query.collection, query.fixedFacets, query.fixedParameters, query.query, query.sortType, query.startRank, query.numRanks, query.facets, query.events);
    const [pastEventsRequest, pastEventsRequestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_7__["find"])(pastEventsQuery.collection, pastEventsQuery.fixedFacets, pastEventsQuery.fixedParameters, pastEventsQuery.query, pastEventsQuery.sortType, pastEventsQuery.startRank, pastEventsQuery.numRanks, pastEventsQuery.facets, pastEventsQuery.events); // save the requestToken
  ...
  const queryElement = props.config.noQuery && props.config.noQuery === true ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_components_query_events_query__WEBPACK_IMPORTED_MODULE_8__["default"], {
    config: props.config,
    query: query,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("form", {
  ...
  }, queryElement, props.config.facetLabels.length > 0 && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_components_filters_events_filtersmobile__WEBPACK_IMPORTED_MODULE_10__["default"], {
    config: props.config,
    query: query,
    pastEventsQuery: pastEventsQuery,
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_components_filters_events_filters__WEBPACK_IMPORTED_MODULE_9__["default"], {
    config: props.config,
    query: query,
    pastEventsQuery: pastEventsQuery,
    response: funnelbackResponse,
    ...
    pastEventsUpdate: pastEventsUpdater,
    clear: clear
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_finder_components_results_finder_results__WEBPACK_IMPORTED_MODULE_11__["default"], {
    clear: clear,
    config: props.config,
    query: query,
    response: funnelbackResponse,
...
function Finder__Results__News(props) {
  const formattedDate = Object(_util__WEBPACK_IMPORTED_MODULE_3__["formatReactDate"])(new Date(props.details.metaData.d)),
    ...
    "aria-hidden": "true"
        ...
        thumbnail = props.details.metaData.thumbnail && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    className: "card__thumbnail"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("picture", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("source", {

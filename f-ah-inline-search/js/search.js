...
var siteUrl = 'citystgeorges.ac.uk';
  ...
  var input = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_20___default.a.createElement("div", {
    ...
    onChange: function onChange(e) {
      ...
      if (e.target.value) {
        ...
        var _suggest = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_16__["suggest"])(props.query.collection, e.target.value, props.config.dxp ? props.config.dxp : false),
...
function Search__OtherSites(props) {
  ...
  }, "Results on other City St George's sites"), props.collections.map(function (collection, i) {
...
/* harmony import */ var _finder_funnelback__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../finder/funnelback */ "./src/patterns/finder/funnelback.js");
/* harmony import */ var _finder_logic_FB_formatter__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../finder/logic/FB-formatter */ "./src/patterns/finder/logic/FB-formatter.js");
/* harmony import */ var focus_trap__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! focus-trap */ "./node_modules/focus-trap/index.js");
/* harmony import */ var focus_trap__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(focus_trap__WEBPACK_IMPORTED_MODULE_18__);
/* harmony import */ var _components_inline_search_inline_query__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/inline/search--inline__query */ "./src/patterns/search/components/inline/search--inline__query.js");
/* harmony import */ var _components_inline_search_inline_suggestions__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./components/inline/search--inline__suggestions */ "./src/patterns/search/components/inline/search--inline__suggestions.js");
/* harmony import */ var _components_inline_search_inline_topresults__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/inline/search--inline__topresults */ "./src/patterns/search/components/inline/search--inline__topresults.js");
...
function InlineSearch(props) {
  ...
  var focusTrap = Object(react__WEBPACK_IMPORTED_MODULE_14__["useRef"])(null);
  var openButtonRef = Object(react__WEBPACK_IMPORTED_MODULE_14__["useRef"])(null);
  var modalButtonRef = Object(react__WEBPACK_IMPORTED_MODULE_14__["useRef"])(null);
  var lastTriggerRef = Object(react__WEBPACK_IMPORTED_MODULE_14__["useRef"])(null);
  ...
  var closeModal = function closeModal() {
    // Deactivate trap first so it does not re-focus the input.
    if (focusTrap.current && typeof focusTrap.current.deactivate === 'function') {
      try {
    ...
    } // Blur the input before moving focus back to the button.
    ...
    setDisplay(false); // Return focus after the modal starts closing.
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])(initialQuery),
      _useState4 = _slicedToArray(_useState3, 2),
      query = _useState4[0],
      setQuery = _useState4[1];

  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])(initialResponse),
      _useState6 = _slicedToArray(_useState5, 2),
      funnelbackResponse = _useState6[0],
      setResponse = _useState6[1];

  var _useState7 = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])(initialSuggestions),
      _useState8 = _slicedToArray(_useState7, 2),
      suggestions = _useState8[0],
      setSuggestions = _useState8[1]; // Boolean to indicate when a query is in progress


  var _useState9 = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])(false),
      _useState10 = _slicedToArray(_useState9, 2),
      updating = _useState10[0],
      setUpdating = _useState10[1]; // Boolean to indicate when a query is in progress


  var _useState11 = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])(false),
      _useState12 = _slicedToArray(_useState11, 2),
      suggestionsUpdating = _useState12[0],
      setSuggestionsUpdating = _useState12[1]; // Request token from the Funnelback request object, so we can cancel if
  ...
  var _useState13 = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])({
    cancel: function cancel() {}
      ...
      call = _useState14[0],
      setCall = _useState14[1]; // useEffect doesn't deep inspect objects, so we need an additional, plain
  ...
  var _useState15 = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])(false),
      _useState16 = _slicedToArray(_useState15, 2),
      update = _useState16[0],
      setUpdate = _useState16[1]; // Request token from the Funnelback request object, so we can cancel if
  // another request is triggered by the user
  ...
  var _useState17 = Object(react__WEBPACK_IMPORTED_MODULE_14__["useState"])({
    cancel: function cancel() {}
      ...
      suggestionsCall = _useState18[0],
      setSuggestionsCall = _useState18[1]; // Retrieve Funnelback results
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_14__["useEffect"])(function () {
    ...
    var _find = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_16__["find"])(query.collection, query.fixedFacets, query.fixedParameters, query.query, query.sortType, query.startRank, query.numRanks, query.facets, query.parameters),
        _find2 = _slicedToArray(_find, 2),
        request = _find2[0],
        requestToken = _find2[1];

    var _suggest = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_16__["suggest"])(query.collection, query.query),
        _suggest2 = _slicedToArray(_suggest, 2),
    ...
    request.then(function (data) {
      setResponse(Object(_finder_logic_FB_formatter__WEBPACK_IMPORTED_MODULE_17__["formatFBResponse"])(data));
      setUpdating(false);
    })["catch"](function () {
  ...
  var updateIndicator = function updateIndicator(what) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("p", {
      ...
      className: "fas fa-sharp fa-spinner fa-pulse icon",
      "aria-hidden": "true"
    }), ' ', /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("span", null, "Updating ", what, "\u2026"));
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_14__["useEffect"])(function () {
    ...
    if (!focusTrap.current) {
      focusTrap.current = focus_trap__WEBPACK_IMPORTED_MODULE_18___default()(modalElement, {
        initialFocus: false,
    ...
    } else if (focusTrap.current.active) {
      focusTrap.current.deactivate({
        returnFocus: false
      });
    }
  ...
  var iconClass = "global-header__search__icon far fa-sharp fa-fw ".concat(display ? 'fa-xmark' : 'fa-search'),
      ...
      veil = display && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("div", {
    className: "veil--search",
    "data-on": "true"
  }),
      toggleButton = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("button", {
    ref: openButtonRef,
  ...
  }, display ? 'Close' : 'Search'), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("span", {
    className: iconClass,
    "aria-hidden": "true"
  }))),
      modalToggleButton = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("button", {
    ref: modalButtonRef,
    className: "global-header__search__button",
    type: "button",
    id: "modal-search",
    ...
    "aria-hidden": "true"
      ...
      inputField = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(_components_inline_search_inline_query__WEBPACK_IMPORTED_MODULE_19__["default"], {
    config: props.config,
    query: query,
    update: updater,
    updating: updating
  }),
      suggestionsList = suggestionsUpdating ? updateIndicator('suggestions') : suggestions && suggestions.length > 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(_components_inline_search_inline_suggestions__WEBPACK_IMPORTED_MODULE_20__["default"], {
    query: query,
    suggestions: suggestions.slice(0, maximumSuggestions)
  }) : null,
      topResults = updating ? updateIndicator('top results') : funnelbackResponse && funnelbackResponse.results.length > 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(_components_inline_search_inline_topresults__WEBPACK_IMPORTED_MODULE_21__["default"], {
    query: query,
    results: funnelbackResponse.results
  }) : null;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_14___default.a.Fragment, null, toggleButton, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("div", {
  ...
  })))), modalToggleButton), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("div", {
    className: "global-header__search__modal__body"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("h2", null, "What are you looking for?"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("form", {
    action: "/search",
    method: "get"
  }, inputField), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_14___default.a.createElement("div", {
...
InlineSearch.propTypes = {
  ...
  element: prop_types__WEBPACK_IMPORTED_MODULE_15___default.a.object
};
...
/* harmony import */ var _finder_logic_FB_formatter__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../finder/logic/FB-formatter */ "./src/patterns/finder/logic/FB-formatter.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../util */ "./src/util.js");
/* harmony import */ var _components_main_results_search_bestbets__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/main/results/search__bestbets */ "./src/patterns/search/components/main/results/search__bestbets.js");
/* harmony import */ var _components_main_results_search_othersites__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./components/main/results/search__othersites */ "./src/patterns/search/components/main/results/search__othersites.js");
...
/* harmony import */ var _components_main_query_search_query__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./components/main/query/search__query */ "./src/patterns/search/components/main/query/search__query.js");
...
/* harmony import */ var zenscroll__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! zenscroll */ "./node_modules/zenscroll/zenscroll.js");
/* harmony import */ var zenscroll__WEBPACK_IMPORTED_MODULE_29___default = /*#__PURE__*/__webpack_require__.n(zenscroll__WEBPACK_IMPORTED_MODULE_29__);
/* harmony import */ var _components_main_results_search_results__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./components/main/results/search__results */ "./src/patterns/search/components/main/results/search__results.js");
...
var oneSecond = 1000,
    scrollDuration = Object(_util__WEBPACK_IMPORTED_MODULE_23__["reduceMotion"])() ? 0 : oneSecond,
...
function Search(props) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_28__["useState"])(0),
      _useState2 = _slicedToArray(_useState, 2),
      response = _useState2[0],
      setResponse = _useState2[1]; // State objects for the Funnelback query and response


  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_28__["useState"])(initialQuery),
      _useState4 = _slicedToArray(_useState3, 2),
      query = _useState4[0],
      setQuery = _useState4[1];

  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_28__["useState"])(initialResponses),
      _useState6 = _slicedToArray(_useState5, 2),
  ...
  var _useState7 = Object(react__WEBPACK_IMPORTED_MODULE_28__["useState"])(false),
      _useState8 = _slicedToArray(_useState7, 2),
      update = _useState8[0],
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_28__["useEffect"])(function () {
    ...
    if (query.query.length > 0) {
      query.interacted && props.element.querySelector('.search__results') && zenscroll__WEBPACK_IMPORTED_MODULE_29___default.a.center(props.element.querySelector('.search__results'), scrollDuration, -window.innerHeight / screenOffsetRatio);
      props.config.primary.collections.forEach(function (collection, i) {
        ...
        request.then(function (data) {
          ...
          responses.primary[i].response = Object(_finder_logic_FB_formatter__WEBPACK_IMPORTED_MODULE_22__["formatFBResponse"])(data);
      ...
      props.config.finders.forEach(function (finder, i) {
        ...
        request.then(function (data) {
          var responses = fbResponses;
          responses.finders[i].response = Object(_finder_logic_FB_formatter__WEBPACK_IMPORTED_MODULE_22__["formatFBResponse"])(data);
          responses.finders[i].updating = false;
          setFbResponses(responses);
          setResponse(Math.random());
        }).then(function () {
          props.element.querySelector('.tabs__links') && query.interacted && zenscroll__WEBPACK_IMPORTED_MODULE_29___default.a.center(props.element.querySelector('.tabs__links'), scrollDuration);
        })["catch"](function () {
          var responses = fbResponses;
      ...
      props.config.nonpublic.forEach(function (nonpublic, i) {
        ...
        request.then(function (data) {
          var responses = fbResponses;
          responses.nonpublic[i].response = Object(_finder_logic_FB_formatter__WEBPACK_IMPORTED_MODULE_22__["formatFBResponse"])(data);
  ...
  var queryElement = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_28___default.a.createElement(_components_main_query_search_query__WEBPACK_IMPORTED_MODULE_27__["default"], {
    config: props.config,
    query: query,
    update: updater,
  ...
  var otherSites = query.query && !fbResponses.primary[0].updating && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_28___default.a.createElement(_components_main_results_search_othersites__WEBPACK_IMPORTED_MODULE_25__["default"], {
    query: query,
  ...
  var bestBets = query.query && !fbResponses.primary[0].updating && fbResponses.primary[0].response && fbResponses.primary[0].response.bestBets && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_28___default.a.createElement(_components_main_results_search_bestbets__WEBPACK_IMPORTED_MODULE_24__["default"], {
    bestbets: fbResponses.primary[0].response.bestBets
  });
  var results = query.query && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_28___default.a.createElement(_components_main_results_search_results__WEBPACK_IMPORTED_MODULE_30__["default"], {
    config: props.config,
    query: query,
    update: updater,
    primary: fbResponses.primary.filter(function (collection) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_28___default.a.createElement("form", {
...
module.exports = __webpack_require__(/*! /opt/azagent/_work/5/s/src/search.js */"./src/search.js");

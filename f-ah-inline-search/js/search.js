...
function InlineSearch(props) {
  ...
  var focusTrap = Object(react__WEBPACK_IMPORTED_MODULE_15__["useRef"])(null);
  ...
  var closeModal = function closeModal() {
    var activeElement = document.activeElement; // First blur the currently focused input.

    if (activeElement && typeof activeElement.blur === 'function') {
      activeElement.blur();
    } // Then deactivate the trap WITHOUT returning focus.


    if (focusTrap.current && typeof focusTrap.current.deactivate === 'function') {
      focusTrap.current.deactivate({
        returnFocus: false,
        checkCanReturnFocus: function checkCanReturnFocus() {
    ...
    setDisplay(false); // iOS sometimes needs another blur after layout changes.
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_15__["useState"])(initialQuery),
      _useState4 = _slicedToArray(_useState3, 2),
      query = _useState4[0],
  ...
  var _useState7 = Object(react__WEBPACK_IMPORTED_MODULE_15__["useState"])(initialSuggestions),
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_15__["useEffect"])(function () {
    ...
    if (!focusTrap.current) {
      focusTrap.current = focus_trap__WEBPACK_IMPORTED_MODULE_19___default()(modalElement, {
        initialFocus: false,
  ...
  var iconClass = "global-header__search__icon far fa-sharp fa-fw ".concat(display ? 'fa-xmark' : 'fa-search'),
      ...
      veil = display && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement("div", {
    className: "veil--search",
    "data-on": "true"
  }),
      toggleButton = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement("button", {
    ref: openButtonRef,
    ...
    "aria-hidden": "true"
      ...
      modalToggleButton = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement("button", {
    ref: modalButtonRef,
    className: "global-header__search__button",
    type: "button",
    id: "modal-search",
    ...
    "aria-hidden": "true"
      ...
      inputField = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement(_components_inline_search_inline_query__WEBPACK_IMPORTED_MODULE_20__["default"], {
    config: props.config,
    query: query,
    update: updater,
    updating: updating
  }),
      suggestionsList = suggestionsUpdating ? updateIndicator('suggestions') : suggestions && suggestions.length > 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement(_components_inline_search_inline_suggestions__WEBPACK_IMPORTED_MODULE_21__["default"], {
    query: query,
    suggestions: suggestions.slice(0, maximumSuggestions)
  }) : null,
      topResults = updating ? updateIndicator('top results') : funnelbackResponse && funnelbackResponse.results.length > 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement(_components_inline_search_inline_topresults__WEBPACK_IMPORTED_MODULE_22__["default"], {
    query: query,
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement("h2", null, "What are you looking for?"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement("form", {
    action: "/search",
    method: "get"
...
InlineSearch.propTypes = {
  ...
  element: prop_types__WEBPACK_IMPORTED_MODULE_16___default.a.object
};

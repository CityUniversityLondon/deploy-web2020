...
/* harmony import */ var _patterns_animation_fade_out_scroll_fade_out_scroll__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./patterns/animation/fade-out-scroll/fade-out-scroll */ "./src/patterns/animation/fade-out-scroll/fade-out-scroll.js");
...
/***/ "./src/patterns/animation/fade-out-scroll/fade-out-scroll.js":
/*!*******************************************************************!*\
  !*** ./src/patterns/animation/fade-out-scroll/fade-out-scroll.js ***!
  \*******************************************************************/
/*! exports provided: default */
 ...
 *  Animates content section to fade in and upwards on down scroll
 *
 * @module paint-layouts/home
 * @author Anett Soos <anett.soos@city.ac.uk>
 * @copyright City, University of London 2022
 */
const className = 'fade-out-scroll';

function addEventFadeOutScroll() {
  console.log('js worked AS');
}
...
/* harmony default export */ __webpack_exports__["default"] = ({
  launchFn: addEventFadeOutScroll,
  launchQuery: `.${className}`
});

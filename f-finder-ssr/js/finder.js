...
/* harmony import */ var _react_util__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./react-util */ "./src/patterns/finder/react-util.js");
...
const oneSecond = 1000,
      scrollDuration = Object(_react_util__WEBPACK_IMPORTED_MODULE_10__["reduceMotion"])() ? 0 : oneSecond,
...
function Finder(props) {
  const params = typeof window !== 'undefined' ? new URLSearchParams(window.location.search) : props.initialQuery ? props.initialQuery : {};
  /**
  ...
  const initialQuery = {
    ...
    interacted: false,
    misspelling: null,
    numRanks: typeof window !== 'undefined' ? params.get('num_ranks') : props.config.numRanks,
    query: typeof window !== 'undefined' ? params.get('query') : '',
    sortType: typeof window !== 'undefined' && params.get('query') ? '' : params.get('sort') || props.config.sort[0].type,
...
Finder.propTypes = {
  ...
  initialQuery: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.object
};
...
/***/ "./src/patterns/finder/react-util.js":
/*!*******************************************!*\
  !*** ./src/patterns/finder/react-util.js ***!
  \*******************************************/
/*! exports provided: uppercaseFirstLetterLowercaseRest, formatTime, axiosRequest, formatReactDate, gaEvent, reduceMotion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function formatTime(timeString) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("time", {
...
function formatReactDate(date) {
  ...
  }, days[date.getUTCDay()], ", ", date.getUTCDate(), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("sup", null, daySuffix(date.getUTCDate())), ' ', months[date.getUTCMonth()], " ", date.getUTCFullYear());
}
/**
...
function reduceMotion() {
  if (typeof window === 'undefined') {
    const reducedMotionQuery = typeof window === 'undefined' ? false : window.matchMedia('(prefers-reduced-motion: reduce)');

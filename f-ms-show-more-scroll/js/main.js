...
function toggleShowMore(showMore) {
  const showMoreContent = showMore.querySelector('.show-more__content'),
  ...
  if (showMoreContent) {
    scrollTo && zenscroll__WEBPACK_IMPORTED_MODULE_2___default.a.to(showMoreContent, scrollDuration);
  }
}
/**

...
/**
 * Remove duplicate duration values from a Funnelback result and render as pipe-separated values.
 *
 * @param {object} props React props.
 * @return {element} - JSX.
 */
...
function Finder__Results__Course(props) {
  const subtitle = props.details.listMetadata.type && props.details.listMetadata.type[0] || props.details.listMetadata.level && props.details.listMetadata.level[0] || null,
    ...
    "aria-hidden": "true"
  }), ' ', /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("span", null, "Duration:"), " ", renderDurations(props)),

...
function () {
  ...
  _createClass(Carousel, [{
    ...
    value: function totalSliderWidth(e) {
      var sliders = Object(_util__WEBPACK_IMPORTED_MODULE_5__["toArray"])(this.checkEventType(e).querySelectorAll('.swiper-slide'));
      var totalWidth = 0;
...
/* harmony import */ var _carousel_constructor__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../carousel-constructor */ "./src/patterns/image-carousel/carousel-constructor.js");
...
function (_Carousel) {
  ...
  function Defaultcarousel(elem, options) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Defaultcarousel).call(this, elem, options));
  }
  ...
  _createClass(Defaultcarousel, [{
    ...
    value: function inital() {
      ...
      thumbnails.forEach(function (e, i) {
        ...
        if (_util__WEBPACK_IMPORTED_MODULE_13__["checkIntersectionObserver"] && !edge) {
          thumbnailsObserver.observe(e);
        } else if (_util__WEBPACK_IMPORTED_MODULE_13__["checkIntersectionObserver"] && edge) {
...
}(_carousel_constructor__WEBPACK_IMPORTED_MODULE_14__["default"]);

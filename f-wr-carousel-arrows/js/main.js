...
/* harmony import */ var _patterns_accordion_accordion_gallery_js__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./patterns/accordion/accordion-gallery.js */ "./src/patterns/accordion/accordion-gallery.js");
...
var Carousel = /*#__PURE__*/function () {
  ...
  _createClass(Carousel, [{
    ...
    value: function checkEventType(e) {
      if (e.target.parentElement.classList.contains('galleria-thumbnail')) {
        ...
        switch (e.type) {
          ...
          default:
            return e.target.closest('.carousel-gallery');
        }
      }
    }
    /**
    ...
    value: function init() {
      ...
      this.elem.querySelector('.carousel-gallery__header').appendChild(buttonsWrap);

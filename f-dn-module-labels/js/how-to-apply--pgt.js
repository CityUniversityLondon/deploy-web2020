...
function HowToApply(props) {
  ...
  function filterMethodsData(methods, dateSpecificPrompt) {
    ...
    methods.map(m => {
      ...
      linkOptions = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_buttons_apply__WEBPACK_IMPORTED_MODULE_2__["default"], {
        data: methodLinks
      });
    ...
    let buttonVal = uniqueLocationDataArray.map(fd => {
      if (fd['options'].length > 0) {
        if (fd['options'][0]['options'].length > 1) {
          ...
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_buttons_apply__WEBPACK_IMPORTED_MODULE_2__["default"], {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    ...
    if (modalVisible) {
      ...
      Object(body_scroll_lock__WEBPACK_IMPORTED_MODULE_1__["disableBodyScroll"])(getModal());
    } else {
      focusTrap.deactivate && focusTrap.deactivate();
      Object(body_scroll_lock__WEBPACK_IMPORTED_MODULE_1__["enableBodyScroll"])(getModal());
    }
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
    ...
    className: "fas fa-sharp fa-times icon",
    "aria-label": "Close"

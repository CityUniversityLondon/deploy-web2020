...
/* harmony import */ var _finder_funnelback__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../finder/funnelback */ "./src/patterns/finder/funnelback.js");
/* harmony import */ var _components_query_events_query__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/query/events__query */ "./src/patterns/events/components/query/events__query.js");
/* harmony import */ var _components_filters_events_filters__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/filters/events__filters */ "./src/patterns/events/components/filters/events__filters.js");
/* harmony import */ var _components_filters_events_filtersmobile__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/filters/events__filtersmobile */ "./src/patterns/events/components/filters/events__filtersmobile.js");
/* harmony import */ var _finder_components_results_finder_results__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../finder/components/results/finder__results */ "./src/patterns/finder/components/results/finder__results.js");
...
function Events(props) {
  ...
  const [funnelbackResponse, setResponse] = Object(react__WEBPACK_IMPORTED_MODULE_6__["useState"])(initialResponse);
  const [pastEventsQuery, setPastEventsQuery] = Object(react__WEBPACK_IMPORTED_MODULE_6__["useState"])(pastEventsInitialQuery);
  const [pastEventsFunnelbackResponse, setPastEventsFunnelbackResponse] = Object(react__WEBPACK_IMPORTED_MODULE_6__["useState"])(pastEventsInitialResponse); // Boolean to indicate when a query is in progress
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_6__["useEffect"])(() => {
    ...
    const [request, requestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_8__["find"])(query.collection, query.fixedFacets, query.fixedParameters, query.query, query.sortType, query.startRank, query.numRanks, query.facets, query.events);
    const [pastEventsRequest, pastEventsRequestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_8__["find"])(pastEventsQuery.collection, pastEventsQuery.fixedFacets, pastEventsQuery.fixedParameters, pastEventsQuery.query, pastEventsQuery.sortType, pastEventsQuery.startRank, pastEventsQuery.numRanks, pastEventsQuery.facets, pastEventsQuery.events); // save the requestToken
  ...
  const queryElement = props.config.noQuery && props.config.noQuery === true ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_components_query_events_query__WEBPACK_IMPORTED_MODULE_9__["default"], {
    config: props.config,
    query: query,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("form", {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_components_filters_events_filters__WEBPACK_IMPORTED_MODULE_10__["default"], {
    config: props.config,
    query: query,
    pastEventsQuery: pastEventsQuery,
    response: funnelbackResponse,
    ...
    pastEventsUpdate: pastEventsUpdater,
    clear: clear
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(_finder_components_results_finder_results__WEBPACK_IMPORTED_MODULE_12__["default"], {
    clear: clear,
    config: props.config,
    query: query,
    response: funnelbackResponse,

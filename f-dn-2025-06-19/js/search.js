...
function Finder__Results__Course(props) {
  var subtitle = props.details.listMetadata.type && props.details.listMetadata.type[0] || props.details.listMetadata.level && props.details.listMetadata.level[0] || null,
    ...
    "aria-hidden": "true"
      ...
      location = String(props.details.listMetadata.location).toLowerCase() !== 'tooting' ? props.details.listMetadata.location && props.query.facets && props.query.facets.location && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement("p", {
    className: "card__tag"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_15___default.a.createElement("span", {
...
function InlineSearch(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_13__["useEffect"])(function () {
    ...
    var _find = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_15__["find"])(query.collection, query.fixedFacets, query.fixedParameters, query.query, query.sortType, query.startRank, query.numRanks, query.facets, query.parameters, props.config.dxp ? props.config.dxp : false),
        _find2 = _slicedToArray(_find, 2),
        request = _find2[0],
        requestToken = _find2[1];

    var _suggest = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_15__["suggest"])(query.collection, query.query, props.config.dxp ? props.config.dxp : false),
        _suggest2 = _slicedToArray(_suggest, 2),
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_27__["useEffect"])(function () {
    ...
    if (query.query.length > 0) {
      ...
      props.config.primary.collections.forEach(function (collection, i) {
        ...
        var _find = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_21__["find"])(collection.collection, [], [], query.query, '', query.startRank, query.numRanks, [], [], props.config.dxp ? props.config.dxp : false),
            _find2 = _slicedToArray(_find, 2),
            request = _find2[0],
            requestToken = _find2[1],
      ...
      props.config.finders.forEach(function (finder, i) {
        ...
        var _find3 = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_21__["find"])(finder.collection, [], [], query.query, '', 1, finder.numRanks, [], [], props.config.dxp ? props.config.dxp : false),
      ...
      props.config.nonpublic.forEach(function (nonpublic, i) {
        ...
        var _find5 = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_21__["find"])(nonpublic.collection, [], [], query.query, '', 1, 0, [], [], props.config.dxp ? props.config.dxp : false),

...
function Finder__Results__Course(props) {
  const subtitle = props.details.metaData.type || props.details.metaData.level || null,
    ...
    "aria-hidden": "true"
        ...
        method = props.details.metaData.method && (props.query.facets && props.query.facets.method || props.query.query.indexOf(props.details.metaData.method) >= 0 || props.details.metaData.method.indexOf('Online') >= 0) && props.details.metaData.type !== 'Short course' && props.details.metaData.type !== 'Professional development course' && props.details.metaData.type !== 'City Health course' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("p", {
    className: "card__tag"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("span", {

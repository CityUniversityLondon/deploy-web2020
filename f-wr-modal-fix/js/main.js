...
/**
 * function that stops scrolling while the modal is open by forcing the scroll position to the stored
 * Y axis position. No reliable CSS only method is available
 *
 * @param {variable} scrollPosY - a variable for storing the screen's Y axis position
 *
 */

...
function accordionizeTabs(root) {
  Array.from(root.querySelectorAll('.tabs')).filter(elem => elem.className.indexOf('.tabs-no-js')).forEach(elem => {
    const potential = tryCatch(() => (0,_patterns_tabs_prepareAccordionTabs__WEBPACK_IMPORTED_MODULE_3__["default"])(elem));
...
function setAutoPlay(video) {
  ...
  if (viewportWidth > (0,_util__WEBPACK_IMPORTED_MODULE_0__.screenWidth)('mobile')) {
    video.autoplay = true;
    video.play();
  }
}
...
function contentFadeIn(contentFadein) {
  ...
  if (!(0,_util__WEBPACK_IMPORTED_MODULE_1__.isMobile)()) {
  ...
  if (value !== 0) {
    ...
    const runAnimation = timestamp => {
      ...
      const progress = (timestamp - startTime) / DURATION,
        finish = progress >= 1,
        animationSpeed = finish ? 1 : 1 - Math.pow(1 - progress, 4);

      // The current number value as the animation runs
      let currentValue = isFloat ? animationSpeed * (value - startValue + startValue).toFixed(1) : null;

      // Restrict animated number to largest whole number; stops larger number appearing and then jumping down, e.g. 3.8% will animate to 3%, then finish on 3.8%, rather than displaying 4% and then dropping down to 3.8%
      ...
      if (finish) {
        ...
        // Check if final rendered number needs formatting
...
function init(elm) {
  ...
  if ((0,_util__WEBPACK_IMPORTED_MODULE_1__.checkIntersectionObserver)()) {
    lazyNumbers.forEach(function (lazyUnit) {
       ...
       */
      (0,_action_on_scroll__WEBPACK_IMPORTED_MODULE_0__.actionOnScroll)(lazyUnit, runNumberAnimation);
    });
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
...
function initBacktoTop(backToTop) {
  ...
  window.addEventListener('load', function () {
    backToTop.querySelector('.back-to-top__button__arrow').appendChild((0,_util__WEBPACK_IMPORTED_MODULE_0__.createHTMLElement)('span', [{
      label: 'content',
      val: 'top'
    }, {
      label: 'class',
...
function launchRemover(elem) {
  ...
  if (warnings.length) {
    ...
    button.addEventListener('click', () => {
      ...
      (0,_util__WEBPACK_IMPORTED_MODULE_0__.removeClass)(elem, className, false);
    }, true);
...
function toggleForm(form, button, buttonText, closeButtonText) {
  const opening = !(0,_util__WEBPACK_IMPORTED_MODULE_1__.toBool)(form.dataset.open),
  ...
  if (opening) {
    ...
    form.addEventListener('transitionend', function openForm() {
      ...
      form.style = null;
      if (scrollTo && !(0,_util__WEBPACK_IMPORTED_MODULE_1__.verticallyInWindow)(doneTarget)) {
        zenscroll__WEBPACK_IMPORTED_MODULE_0___default().to(doneTarget, scrollDuration);
      }
    }, true);
...
function sendFeedback(action, value) {
  (0,_util__WEBPACK_IMPORTED_MODULE_1__.gaEvent)('pageFeedback', 'Page feedback', action, window.location.toString(), value, true);
}
...
function handleNo(container) {
  ...
  (0,_util__WEBPACK_IMPORTED_MODULE_1__.appendAll)(message, [messagePrefix, link, messageSuffix]);
...
function launchFeedback(elem) {
  ...
  (0,_util__WEBPACK_IMPORTED_MODULE_1__.appendAll)(buttonWrapper, [yesButton, noButton]);
  (0,_util__WEBPACK_IMPORTED_MODULE_1__.appendAll)(directFeedbackFieldset, [questionLegend, buttonWrapper]);
...
function createMap(mapContainer) {
  ...
  function createMarker(markerConfig) {
    ...
    listItem = (0,_util__WEBPACK_IMPORTED_MODULE_0__.createHTMLElement)('li', [{
      label: 'id',
    ...
    anchor = (0,_util__WEBPACK_IMPORTED_MODULE_0__.createHTMLElement)('a', [{
      label: 'html',
  ...
  function parseXml(xml) {
    ...
    Array.from(items).forEach(function (item) {
      ...
      searchTags.push((0,_util__WEBPACK_IMPORTED_MODULE_0__.createHTMLElement)('a', [{
        label: 'content',
    ...
    function searchBoxInit() {
      ...
      function searchSuggestions() {
        ...
        if (searchString.length > 0) {
          ...
          let createListWrapper = (0,_util__WEBPACK_IMPORTED_MODULE_0__.createHTMLElement)('div', [{
            label: 'class',
            val: 'query__suggestions__wrapper'
          }]);
          let createList = (0,_util__WEBPACK_IMPORTED_MODULE_0__.createHTMLElement)('ul', [{
            label: 'id',
          ...
          let clearSearchButton = (0,_util__WEBPACK_IMPORTED_MODULE_0__.createHTMLElement)('button', [{
            label: 'class',
          ...
          Array.from(searchTags).forEach(function (tag) {
            if (tag.textContent.toLowerCase().indexOf(searchString.toLowerCase()) > -1) {
              if (counter < maxNumberSuggestions) {
                let item = (0,_util__WEBPACK_IMPORTED_MODULE_0__.createHTMLElement)('li', []);
                let anchor = (0,_util__WEBPACK_IMPORTED_MODULE_0__.createHTMLElement)('a', [{
                  label: 'tabindex',
                  val: -1
                }, {
                  label: 'data-id',
  ...
  function init() {
    ...
    mapContainer.appendChild((0,_util__WEBPACK_IMPORTED_MODULE_0__.createHTMLElement)('i', [{
      label: 'class',
...
function handleLoadMoreClick(keyInformation) {
  ...
  if (firstElement && scrollTo && !(0,_util__WEBPACK_IMPORTED_MODULE_0__.verticallyInWindow)(firstElement)) {
    zenscroll__WEBPACK_IMPORTED_MODULE_2___default().to(firstElement, scrollDuration);
  }
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../util */ "./src/util.js");
/* harmony import */ var _aria_attributes__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../aria-attributes */ "./src/aria-attributes.js");
/* harmony import */ var _menu_formatters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./menu-formatters */ "./src/patterns/menu/menu-formatters.js");
...
function toggleMenu(button, setMenu, trap, veil) {
  const expanded = button.getAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].expanded);
  if ((0,_util__WEBPACK_IMPORTED_MODULE_0__.toBool)(expanded)) {
    trap.deactivate();
...
function createMenuToggle(label, button, setMenu, veil) {
  ...
  button.setAttribute('type', 'button');
  button.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].hasPopup, 'menu');
  button.setAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].label, 'Toggle menu');
  Array.from(label.childNodes).forEach(child => buttonWrapper.appendChild(child));
  button.appendChild(buttonWrapper);
  const trap = (0,focus_trap__WEBPACK_IMPORTED_MODULE_3__.createFocusTrap)(menu, {
    /**
     ...
     */
    initialFocus: () => {
      const open = Array.from(menu.querySelectorAll([`.${contentHeaderClassName} > span`, `.${currentClassName} > .${controlsClassName} > a`, `.${hierarchyClassName} > .${controlsClassName} > a`, `.${level1ClassName} > ul > li:first-of-type > .${controlsClassName} > a`, `.${currentPage} > a`].join(','))).filter(elem => (0,_util__WEBPACK_IMPORTED_MODULE_0__.isVisible)(elem));
...
function launchMenu(menu) {
  ...
  setMenu(false);
  (0,_menu_formatters__WEBPACK_IMPORTED_MODULE_2__.prepareNavigation)(menu.querySelector(`.${level1ClassName}`), className);
  (0,_menu_formatters__WEBPACK_IMPORTED_MODULE_2__.listenForNavigationToggles)(menu.querySelector(`.${level1ClassName}`), className);
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  launchFn: launchMenu,
  launchQuery: `.${className}`
...
function closeDialog(dialog, modal) {
  ...
  if (scrollTo && !(0,_util__WEBPACK_IMPORTED_MODULE_0__.verticallyInWindow)(modal)) {
    zenscroll__WEBPACK_IMPORTED_MODULE_2___default().to(modal, scrollDuration);
  }
}
function trapFocus(modal) {
  let modalInner = modal.querySelector('.dialog__inner');
  trap = (0,focus_trap__WEBPACK_IMPORTED_MODULE_3__.createFocusTrap)(modalInner, {
    clickOutsideDeactivates: true
  });
  trap.activate();
}
...
function createSectionToggle(button, closeAll, veil) {
  return () => {
    const open = !(0,_util__WEBPACK_IMPORTED_MODULE_0__.toBool)(button.getAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].expanded));
    closeAll();
    if (open) {
...
function prepareTopLevel(navigation, veil, closeAll) {
  ...
  topLevels.forEach(el => {
    ...
    (0,_util__WEBPACK_IMPORTED_MODULE_0__.appendAll)(buttonDiv, [srOpenCloseSpan, document.createTextNode(' '), el, document.createTextNode(' '), srNavigationSpan]);
...
function setupTabPrevious(navigation, closeAll, veil) {
  const firstButton = navigation.querySelector('.navigation--primary__level1:first-of-type > .navigation__button'),
    restButtons = Array.from(navigation.querySelectorAll('.navigation--primary__level1:not(:first-of-type) > .navigation__button'));

  // If we tab out of the open, first menu into the other header content, close the menu.
  firstButton.addEventListener('keydown', e => {
    if ((0,_util__WEBPACK_IMPORTED_MODULE_0__.toBool)(firstButton.getAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].expanded)) && tabKey === e.key && e.shiftKey) {
      closeAll();
    }
  });
  restButtons.forEach(thisSectionButton => {
    ...
    thisSectionButton.addEventListener('keydown', e => {
      if ((0,_util__WEBPACK_IMPORTED_MODULE_0__.toBool)(thisSectionButton.getAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].expanded)) && tabKey === e.key && e.shiftKey) {
        e.preventDefault();
...
function setupTabNext(navigation, closeAll, veil) {
  const closeButton = navigation.querySelector('.navigation--primary__level1:last-of-type .wrapper--navigation--primary__menu__close button'),
    restSectionsCloseButtons = Array.from(navigation.querySelectorAll('.navigation--primary__level1:not(:last-of-type) .wrapper--navigation--primary__menu__close button'));

  // If we tab out of the open, first menu into the other header content, close the menu.
  closeButton.addEventListener('keydown', e => {
    if ((0,_util__WEBPACK_IMPORTED_MODULE_0__.toBool)(closeButton.closest('.navigation--primary__level1').querySelector('button').getAttribute(_aria_attributes__WEBPACK_IMPORTED_MODULE_1__["default"].expanded)) && tabKey === e.key && !e.shiftKey) {
      closeAll();
    }
  });
...
function addCloseButtons(navigation, closeAll) {
  Array.from(navigation.querySelectorAll('.navigation--primary__menu__content')).forEach(menu => {
    ...
    (0,_util__WEBPACK_IMPORTED_MODULE_0__.appendAll)(closeButtonDiv, [closeButtonText, closeButtonIcon]);
...
function launchSecondaryNavigation(navigation) {
  ...
  (0,_menu_menu_formatters__WEBPACK_IMPORTED_MODULE_0__.prepareSideNavigation)(navigation, className);
  (0,_menu_menu_formatters__WEBPACK_IMPORTED_MODULE_0__.listenForNavigationToggles)(navigation, className);
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
...
function launchPaginatedList(list) {
  if (!(list.tagName === 'UL' || list.tagName === 'OL')) {
     ...
     */
    (0,_util__WEBPACK_IMPORTED_MODULE_1__.removeClass)(list, className, false);
    return;
  }
  ...
  (0,_pagination_pagination_js__WEBPACK_IMPORTED_MODULE_0__.addPagination)(list, listItems.length);
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addPagination: () => (/* binding */ addPagination),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   pageClassName: () => (/* binding */ pageClassName)
/* harmony export */ });
/* harmony import */ var zenscroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! zenscroll */ "./node_modules/zenscroll/zenscroll.js");
/* harmony import */ var zenscroll__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(zenscroll__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../util */ "./src/util.js");
...
function createOpenPage(pages, controls, toggleNextPrev) {
  ...
  const openPage = (pageNumber, focus, scrollTo) => {
    ...
    focus && page.focus();
    scrollTo && zenscroll__WEBPACK_IMPORTED_MODULE_0___default().to(page, scrollDuration);
  };
  return openPage;
}
...
function addPagination(elem, itemCount) {
  ...
  if (!pages.length > 1) {
     ...
     * styles then bail
     */
    (0,_util__WEBPACK_IMPORTED_MODULE_1__.removeClass)(elem, className, false);
    return;
  }
...
function toggleShowMore(showMore) {
  const firstHeadingElement = showMore.querySelector('.show-more__heading, h2, h3, h4, h5, h6'),
    ...
    hiddenElement = (0,_util__WEBPACK_IMPORTED_MODULE_0__.toBool)(contentElement.dataset.hidden);
  if (hiddenElement) {
  ...
  if (firstHeadingElement && !(0,_util__WEBPACK_IMPORTED_MODULE_0__.verticallyInWindow)(firstHeadingElement)) {
    scrollTo && zenscroll__WEBPACK_IMPORTED_MODULE_2___default().to(firstHeadingElement, scrollDuration);
  }
}
...
function accordionize(tabs) {
  ...
  Array.from(tabs.parentNode.querySelectorAll(`#${tabs.id} > .${panelClassName}`)).forEach(panel => {
    ...
    (0,_util__WEBPACK_IMPORTED_MODULE_1__.appendAll)(accordion, [accordionHeading, accordionSection]);
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (prepareAccordionTabs);
...
function selectTab(newTab) {
   ...
   */
  newTab.focus();
  scrollTo && zenscroll__WEBPACK_IMPORTED_MODULE_0___default().to(tabs, scrollDuration);
...
function launchTabs(tabs) {
  ...
  if (linkItems.length === 1) {
     ...
     */
    (0,_util__WEBPACK_IMPORTED_MODULE_1__.removeClass)(tabs, className, false);
    return;
  }
  ...
  if (window.location.hash) {
    ...
    // checks if button in Hash is found inside this tabs pattern
    ...
    if (button) {
      ...
      if (isTabAccordion && (0,_util__WEBPACK_IMPORTED_MODULE_1__.screenWidth)('tablet') < viewportWidth) {
...
function toggleImageCredit(wrapper) {
  ...
  if ((0,_util__WEBPACK_IMPORTED_MODULE_1__.toBool)(wrapper.dataset.open)) {
...
function launchImageCredit(picture) {
  const display = (0,_util__WEBPACK_IMPORTED_MODULE_1__.toBool)(picture.dataset.tooltipdisplay),
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["react","vendor-dependencies","axios","vendor-direct","core"], () => (__webpack_require__("./src/main.js")))

...
/******/ 	deferredModules.push([8,"react","vendor-dependencies","axios","vendor-direct","core"]);
...
/* harmony import */ var _components_query_events_query__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/query/events__query */ "./src/patterns/events/components/query/events__query.js");
...
/* harmony import */ var _finder_components_results_finder_results__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../finder/components/results/finder__results */ "./src/patterns/finder/components/results/finder__results.js");
...
function Events(props) {
  ...
  const [funnelbackResponse, setResponse] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(initialResponse);
  const [pastEventsQuery, setPastEventsQuery] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(pastEventsInitialQuery);
  const [pastEventsFunnelbackResponse, setPastEventsFunnelbackResponse] = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(pastEventsInitialResponse); // Boolean to indicate when a query is in progress
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(() => {
    ...
    const [request, requestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_3__["find"])(query.collection, query.fixedFacets, query.fixedParameters, query.query, query.sortType, query.startRank, query.numRanks, query.facets, query.events);
    const [pastEventsRequest, pastEventsRequestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_3__["find"])(pastEventsQuery.collection, pastEventsQuery.fixedFacets, pastEventsQuery.fixedParameters, pastEventsQuery.query, pastEventsQuery.sortType, pastEventsQuery.startRank, pastEventsQuery.numRanks, pastEventsQuery.facets, pastEventsQuery.events); // save the requestToken
  ...
  const queryElement = props.config.noQuery && props.config.noQuery === true ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_query_events_query__WEBPACK_IMPORTED_MODULE_4__["default"], {
    config: props.config,
    query: query,
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("form", {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_components_filters_events_filters__WEBPACK_IMPORTED_MODULE_5__["default"], {
    config: props.config,
    query: query,
    pastEventsQuery: pastEventsQuery,
    response: funnelbackResponse,
    ...
    pastEventsUpdate: pastEventsUpdater,
    clear: clear
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_finder_components_results_finder_results__WEBPACK_IMPORTED_MODULE_7__["default"], {
    clear: clear,
    config: props.config,
    query: query,
    response: funnelbackResponse,
...
function Finder__Reset(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    ...
    className: "far fa-sharp fa-fw fa-times icon"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
...
function Finder__Tag(props) {
  ...
  return props.query.facets[props.facet.meta] ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    className: "fa-fw far fa-sharp fa-times icon",
    "aria-hidden": "true"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {

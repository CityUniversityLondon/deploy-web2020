...
/* harmony import */ var _finder_funnelback__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../finder/funnelback */ "./src/patterns/finder/funnelback.js");
...
function Search(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_7__["useEffect"])(() => {
    ...
    if (query.query.length > 0) {
      ...
      props.config.primary.collections.forEach((collection, i) => {
        ...
        const [request, requestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_13__["find"])(collection.collection, [], query.query, '', query.startRank, query.numRanks, []),
      ...
      props.config.finders.forEach((finder, i) => {
        ...
        const [request, requestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_13__["find"])(finder.collection, [], query.query, '', 1, finder.numRanks, []),
              newResponses = fbResponses;
      ...
      props.config.nonpublic.forEach((nonpublic, i) => {
        ...
        const [request, requestToken] = Object(_finder_funnelback__WEBPACK_IMPORTED_MODULE_13__["find"])(nonpublic.collection, [], query.query, '', 1, 0, []),
              newResponses = fbResponses;
  ...
  const queryElement = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_components_main_query_search_query__WEBPACK_IMPORTED_MODULE_11__["default"], {
    config: props.config,
    query: query,
    update: updater,
  ...
  const otherSites = query.query && !fbResponses.primary[0].updating && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_components_main_results_search_othersites__WEBPACK_IMPORTED_MODULE_9__["default"], {
    query: query,
    collections: fbResponses.primary.filter(collection => collection.collection !== query.collection),
    nonpublic: fbResponses.nonpublic
  });
  const bestBets = query.query && !fbResponses.primary[0].updating && fbResponses.primary[0].response && fbResponses.primary[0].response.bestBets && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_components_main_results_search_bestbets__WEBPACK_IMPORTED_MODULE_8__["default"], {
    bestbets: fbResponses.primary[0].response.bestBets
  });
  const results = query.query && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_components_main_results_search_results__WEBPACK_IMPORTED_MODULE_12__["default"], {
    config: props.config,
    query: query,
    update: updater,
    primary: fbResponses.primary.filter(collection => collection.collection === query.collection),

...
function finder__query(props) {
  ...
  if (hub) {
    ...
    if (hub) {
      findButton = react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("button", {
        type: "submit",
    ...
    }, react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("div", null, input, findButton));
  }
}

...
function Finder__Results__Funding(props) {
  ...
  const school = props.details.listMetadata.school && props.query.facets && props.query.facets.school && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", {
    ...
    "aria-hidden": "true"
        ...
        fundingStatus = props.details.listMetadata.fdate && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", {
    className: "card__tag"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", {
    className: "far fa-fw fa-calendar-clock icon",
    "aria-hidden": "true"
  }), ' ', /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", null, "Funding status:"), ' ', /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", null, props.details.listMetadata.rolling ? 'Rolling application' : props.details.listMetadata.fdate >= intDate ? 'Open' : props.details.listMetadata.fdate < intDate ? 'Closed' : null));
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("li", {
    ...
    className: "card__description"
  }, props.details.listMetadata.c && props.details.listMetadata.c[0]), level, programme, feestatus, school, fundingStatus)));
}
...
/* harmony import */ var _finder_select_no_response__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./finder__select__no-response */ "./src/patterns/finder/components/filters/finder__select__no-response.js");
...
function Finder__Filters(props) {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_finder_reset__WEBPACK_IMPORTED_MODULE_6__["default"], {
    clear: props.clear,
    resetSort: false
  })) : null,
        clearFiltersMobile = Object.keys(props.query.facets).length > 0 || props.query.sortType !== props.config.sort[0].type ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_finder_reset__WEBPACK_IMPORTED_MODULE_6__["default"], {
    clear: props.clear,
    resetSort: true
  }) : null;
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_finder_sort__WEBPACK_IMPORTED_MODULE_7__["default"], {
    config: props.config,
    query: props.query,
    update: props.update
  })) : null;
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    if (dependencyMet(facet, props.query.facets)) {
      switch (facet.type) {
        ...
        case 'selectMode':
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_finder_select_no_response__WEBPACK_IMPORTED_MODULE_3__["default"], {
            key: facet.meta,
            facet: facet,
            query: props.query,
            responseFacet: props.response && props.response.facets ? props.response.facets.filter(funnelbackFacet => funnelbackFacet.name === facet.funnelbackName) : [],
        ...
        case 'tag':
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_finder_tag__WEBPACK_IMPORTED_MODULE_5__["default"], {
            key: facet.meta,
            facet: facet,
            query: props.query,
            responseFacet: props.response && props.response.facets ? props.response.facets.filter(funnelbackFacet => funnelbackFacet.name === facet.funnelbackName) : [],
...
/***/ "./src/patterns/finder/components/filters/finder__select__no-response.js":
/*!*******************************************************************************!*\
  !*** ./src/patterns/finder/components/filters/finder__select__no-response.js ***!
  \*******************************************************************************/
/*! exports provided: default */
...
function replaceHistory(currQuery, currStartRank, currFacets, currSort, currMode, facetLabels, defaultSort) {
  if (window) {
    ...
    currMode ? params.set('mode', currMode) : params.delete('mode');
...
function Finder(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    // preserve the state
    replaceHistory(query.query, query.startRank, query.facets, query.sortType, query.mode, props.config.facetLabels, props.config.sort[0].type); // indicate a request is in progress
    ...
    const [request, requestToken] = Object(_funnelback__WEBPACK_IMPORTED_MODULE_2__["find"])(query.collection, query.fixedFacets, query.fixedParameters, query.query, query.sortType, query.startRank, query.numRanks, query.facets, query.events, query.mode); // save the requestToken
...
function find(collection, fixedFacets, fixedParameters, query, sortType, startRank, numRank, facets, events, mode) {
  const fixedParams = {};
  ...
  facetKeys.forEach(key => {
    if (key === 'mode') {
      return facetParams[key] = facets[key];
    } else {
      return facetParams[`meta_${key}_sand`] = facets[key];
    }
  });
